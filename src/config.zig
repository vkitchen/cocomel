...
pub const query_buffer_size = 65536; // splade has big queries
pub const max_top_k = 1000;
pub const max_term_length = 100; // used during indexing
pub const max_query_terms = 6000; // splade has big queries
